...
void executeTraffixMatrix(Logfile& logfile, uint64_t base_inter_rtt, uint64_t base_intra_rtt) {
    ...
    vector<CbrSrc*>             intra_cbr_srcs;
    vector<CbrSrc*>             inter_srcs;
...
int main(int argc, char** argv) {
    ...
    CbrSrc::setRouteStrategy(sim_params.route_strategy);
    CbrSink::setRouteStrategy(sim_params.route_strategy);
