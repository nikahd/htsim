...
#define RECORD_PATH_LENS  // used for debugging which paths lengths packets were trimmed on - mostly
                          // useful for BCube
...
private:
    ...
    void send_ack(simtime_picosec  ts,
                  ...
                  bool             ecn_marked,
                  bool             enqueue_pull);
    void send_nack(simtime_picosec  ts,
                   NdpPacket::seq_t ackno,
                   NdpPacket::seq_t pacer_no,
                   bool             enqueue_pull,
                   bool             ecn_marked);
...
public:
    ...
    // void set_preferred_flow(int id) { _preferred_flow = id;cout << "Preferring flow "<< id <<
    // endl;};
