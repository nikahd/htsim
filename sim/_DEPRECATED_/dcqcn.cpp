...
void DCQCNSrc::doNextEvent() {
    ...
    cout << "Adding " << (_highest_sent - _old_highest_sent) << " to sent bytes " << _byte_counter
         << " " << _highest_sent << endl;
...
DCQCNSink::DCQCNSink(EventList& eventlist) : RoceSink(), EventSource(eventlist, "DCQCN Sink") {
