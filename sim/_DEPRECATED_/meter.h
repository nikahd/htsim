...
/*
 * A simple Meter that returns RED or GREEN depending on whether the current packet fits in the
 * meter or not. If it does the packet is considered enqueued.
 */
...
typedef enum { METER_RED, METER_GREEN } meter_output;
