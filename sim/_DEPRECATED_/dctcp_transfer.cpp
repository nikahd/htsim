...
DCTCPSrcTransfer::DCTCPSrcTransfer(TcpLogger*            logger,
...
void DCTCPSrcTransfer::connect(const Route&    routeout,
...
void DCTCPSrcTransfer::doNextEvent() {
    if (!_is_active) {
        _is_active = true;
        ...
        DCTCPSrc::doNextEvent();
}

void DCTCPSrcTransfer::receivePacket(Packet& pkt) {
    if (_is_active) {
