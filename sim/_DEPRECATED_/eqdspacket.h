...
public:
    ...
    inline static EqdsDataPacket* newpkt(PacketFlow&  flow,
                                         const Route& route,
                                         seq_t        epsn,
                                         mem_b        full_size,
                                         PacketType   pkttype,
...
public:
    inline static EqdsPullPacket* newpkt(PacketFlow&    flow,
                                         const route_t* route,
                                         pull_quanta    pullno,
                                         uint16_t       path_id,
                                         uint32_t       destination = UINT32_MAX) {
...
public:
    inline static EqdsAckPacket* newpkt(PacketFlow&  flow,
                                        const Route* route,
                                        seq_t        cumulative_ack,
                                        seq_t        ref_ack, /*pull_quanta pullno,*/
                                        uint16_t     path_id,
                                        bool         ecn_marked,
                                        uint32_t     destination = UINT32_MAX) {
...
public:
    inline static EqdsNackPacket* newpkt(PacketFlow&  flow,
                                         const Route* route,
...
public:
    inline static EqdsRtsPacket* newpkt(PacketFlow&  flow,
                                        const Route* route,
                                        seq_t        epsn,
                                        pull_quanta  pull_target,
                                        bool         to,
