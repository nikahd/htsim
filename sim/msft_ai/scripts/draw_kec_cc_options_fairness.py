...
for matrix in connection_matrices:
    for link_down in is_link_down:
        for droprate in drop_rate:
            for bitmapsize in bitmap_size:
                figure_file_name = f"{folder_name}/option_plots/fairness_{matrix}_link{link_down}_usejitter{use_jitter}_droprate{droprate}_mimd{apply_mimd}_initcwnd0.7.png"
