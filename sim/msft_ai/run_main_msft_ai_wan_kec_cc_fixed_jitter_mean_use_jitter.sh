...
CONN_MATRICES=("one_one_1_200MB.cm" "one_one_2_200MB.cm" "one_one_4_200MB.cm" "one_one_8_200MB.cm" "one_one_16_200MB.cm" "one_one_32_200MB.cm" "one_one_64_200MB.cm")
IS_LINK_DOWN=(1)
drop_rates=("mean")
use_jitter=1
...
bitmap_full_percent=(0.6 0.8 0.9)
use_replace_path=(0 1) 
original_loss_path_replace_threshold=(0.5 0.7 0.9)
original_jittery_path_replace_threshold=(0.1 0.3 0.5)
apply_mimd=1
