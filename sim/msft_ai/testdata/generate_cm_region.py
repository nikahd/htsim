# Generate connection matrix for AI region Routingtest (up to Regional Hub)
# By changing the iteration of dc_idx, leafgroup_idx, torgroup_idx, and serv_idx, you can generate different connection matrices
# with one connection sending packets at a time.
# output connection matrix file: 1_routing_region.cm 
...
if __name__ == "__main__":
    ...
    tm_file = f"1_{testcase}_region.cm"
